  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="partnerList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="分成比例" align="center" prop="profitRatio" >
        <template #default="scope">
          ...
          <el-tag v-if="scope.row.profitRatio">{{ scope.row.profitRatio }}%</el-tag>
        </template>
      </el-table-column>
    ...
    <!-- 查看合作商详情对话框 -->
     <el-dialog :title="'合作商详情'" v-model="partnerInfoOpen" width="500px" append-to-body>
      <!-- <el-row>
        <el-col :span="12"><strong>合作商名称：</strong>{{ form.partnerName }}</el-col>
        <el-col :span="12"><strong>联系人：</strong>{{ form.contactPerson }}</el-col>        
      </el-row>
      <el-row>
        <el-col :span="12"><strong>联系电话：</strong>{{ form.contactPhone }}</el-col>
        <el-col :span="12"><strong>分成比例：</strong>{{ form.profitRatio }}%</el-col>        
      </el-row> -->
